...
public class NeoElevatorPIDController extends CommandBase {
   ...
   */
  public NeoElevatorPIDController(NeoElevatorPIDNonProfiled elevatorPIDSubsystem,/*ElevatorPID elevatorPIDSubsystem,*/ XboxController controller) {
